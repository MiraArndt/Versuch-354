...
\begin{equation}
    I(t) = I_1 e^{i w_1 t} + I_2 e^{i w_2 t},
    \label{eq:lsg}
\end{equation}
\noindent
wobei $I_1$ und $I_2$ komplexe Koeffizienten darstellen, bestimmt werden. Wird nun die 
Darstellung
\begin{align}
    \mu = \frac{R}{4\pi L} \nonumber \\
...
\begin{equation}
    I(t) = e^{-2\pi \mu t} \left( I_1 e^{i 2 \pi \nu t} + I_2 e^{-i 2 \pi \nu t} \right)
...
zwischen $I_1$ und $I_2$ notwendigerweise die Beziehung $I_1 = \bar{I_2}$ gelten. Folglich lassen 
sie sich mithilfe der Euler-Formel in die Form
\begin{align*}
    I_1 = \frac{1}{2} A_0 e^{i \eta} \\
    I_2 = \frac{1}{2} A_0 e^{-i \eta}
\end{align*}
...
deren Amplitude mit fortlaufender Zeit exponentiell abnimmt. Die Schwingungsdauer kann
...
\begin{equation}
    L \frac{\mathrm{d}I}{\mathrm{d}t} + RI + \frac{Q}{C} = U_0 e^{i\omega t}
\end{equation}
