...
\begin{equation*}
  R_{eff}=(0,07224\pm0,0021)\,\si{\ohm}
\end{equation*}
...
welcher $R_G=600\,\si{\ohm}$ beträgt.(INVERSES KLÄREN)
...
\noindent berechnen. Beim Verglich mit dem Messwert fällt wieder 
...
nun $R=(271,6\pm0,1)\,\si{\ohm} + 600\,\si{\ohm}$ angenommen. (VERGLEICH)
...
\noindent fällt auf, dass(VERGLEICH). Auch hier wurde $R=(271,6\pm0,1)\,\si{\ohm} + 600\,\si{\ohm}$ angenommen.
\begin{figure}[H]
  \centering
